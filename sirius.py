...
bottoken = "MTAxNjQ1NDc1NTE1MDcyNTE1MA.G2mcB1.bIGdS9IsyHh4aoITS4hUO5pKcBAyygb4Q82jIE"
...
mydb = mysql.connector.connect(
    host="localhost",
    user="root",
    password="dSJKFNKJDNFALSne821539SkljnaSFnlfsalk",
    database="xdb-db"
)
...
async def register(ctx):
    ...
    if (str(check))  == "991171254520397855":
